...
<section role="main" class="content-body">
    ...
    <div class="blogs-create container-fluid">
        <div class="blogs-form">
            <?php $form = ActiveForm::begin(['id' => 'create-seo']); ?>
            <div class="row">
                <div class="col-md-6">
                    <label>Route</label>
                    <?= $form->field($model, 'route')->textInput(['autocomplete' => 'off'])->label(false) ?>
                </div>
                <div class="col-md-6">
                    <label>Title</label>
...
<?php
$script = <<<JS
$(document).on('submit','#create-seo',function (event){
