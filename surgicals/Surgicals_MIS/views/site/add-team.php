...
<?php $form = ActiveForm::begin(['id' => 'add-team']); ?>
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <label>Charges</label>
                <?= $form->field($model, 'charges')->textInput(['autocomplete' => 'off'])->label(false); ?>
            </div>
            <div class="col-md-3">
...
$(document).on('submit','#add-team',function (event){
