...
$this->title = 'Add Faqs';
$faq_type = [0=>'Others', 1 => 'Account', 2 => 'Order', 3 => 'Payment', 4 => 'Deliveries', 5 => 'Cancellations & Modifications', 6 => 'Returns & Refunds', 7 => 'Coupon & Flash sales'];
?>
...
<?php $form = ActiveForm::begin(['id' => 'faq-form']); ?>
    <div class="row">
        ...
        <div class="col-md-6">
            <?= $form->field($model, 'type')->dropDownList($faq_type,['prompt' => 'Select Type','class' => 'form-control']) ?>
        </div>
        <div class="col-md-12">
