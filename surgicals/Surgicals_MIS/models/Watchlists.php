...
/**
 * This is the model class for table "watchlists".
 *
 * @property int $id
 ...
 */
class Watchlists extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['enc_id', 'product_id', 'counter', 'created_by'], 'required'],
            [['created_on', 'updated_on'], 'safe'],
            [['is_deleted'], 'integer'],
            [['enc_id', 'product_id', 'created_by', 'updated_by'], 'string', 'max' => 50],
            [['counter'], 'string', 'max' => 255],
            [['enc_id'], 'unique'],
