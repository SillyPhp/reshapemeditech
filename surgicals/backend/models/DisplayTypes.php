...
/**
 * This is the model class for table "display_types".
 *
 * @property int $id
 ...
 */
class DisplayTypes extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(DisplayDetails::className(), ['display_type_id' => 'enc_id']);
    }
